...
--INSERT INTO `me_article` VALUES ('', '0', '2018-02-01 14:47:19', '本节将介绍如何在项目中使用 Element。', 'Element相关', '3', '0', '1', '21', '1');
--INSERT INTO me_article(id,create_date,summary,title,author_id,category_id,query_id)
--VALUES(38,'2023-01-01 14:47:19','本节将介绍如何在项目中使用 Element。','Element相关',16,1,38);
--DELETE FROM me_article
--WHERE id = 38;
--
---- ----------------------------
...
---- ----------------------------
insert into `me_category` VALUES ('1', '/category/1.png', '寻去处', null);
insert into `me_category` VALUES ('2', '/category/2.png', '欢迎来', null);
...
---- Records of me_tag
---- ----------------------------
insert into `me_tag` VALUES ('1', '/tag/1.png', '钓鱼');
insert into `me_tag` VALUES ('2', '/tag/2.png', '老少皆宜休闲');
insert into `me_tag` VALUES ('3', '/tag/3.png', '农家院');
insert into `me_tag` VALUES ('4', '/tag/4.png', '温泉度假');
insert into `me_tag` VALUES ('5', '/tag/5.png', '僻静休闲');
insert into `me_tag` VALUES ('6', '/tag/6.png', '游乐场');
