...
const router = new Router({
  routes: [
    {
      path: '/responseWrite',
      component: r => require.ensure([], () => r(require('@/views/blog/ResponseWrite')), 'reponseWrite'),
      meta: {
        requireLogin: true
      },
    },
    ...
    {
      path: '/result',
      component: r => require.ensure([], () => r(require('@/views/MoneyResult')), 'moneyresult'),
    },
    {
      path: '',
      name: 'Home',
    ...
    {
      path:'/moneyInfo',
      component: r => require.ensure([], () => r(require('@/views/MoneyInfo')), 'moneyinfo'),
    }
